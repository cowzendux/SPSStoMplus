...
* Will also create a file just containing the variables in the data set so that programs built off of the 
* original .inp file can be updated easily.
...
* Will load the file "C:/users/jamie/workspace/Project/Data/SPSSfile.sav", convert 
* it to be consistent with Mplus guidelines, and save the data in a text file named 
* "C:/users/jamie/workspace/Project/Data/Mplus data/SPSSfile.dat". It will also 
* create a skeleton .inp file named 
* C:/users/jamie/workspace/Project/Data/Mplus data/SPSSfile.inp" that will load 
